...
#define GETAPLUS2BPLUSC( A, B, C)  ( (A) +  (B) + (B)  + (C)  ) 
    ...
    LIBMWVISIONRT_API void MWVIP_OpticalFlow_LK_GDER_D(void **inPortAddr,
        real_T  *outVel, 
        real_T  *gradCC,
        real_T  *gradRC,
        real_T  *gradRR,
    ...
    LIBMWVISIONRT_API void MWVIP_OpticalFlow_LK_GDER_R(void **inPortAddr,
        real32_T  *outVel, 
        real32_T  *gradCC,
        real32_T  *gradRC,
        real32_T  *gradRR,
    ...
    LIBMWVISIONRT_API void MWVIP_OpticalFlow_LK_GDER_Z(void **inPortAddr,
        creal_T  *outVel, 
        real_T  *gradCC,
        real_T  *gradRC,
        real_T  *gradRR,
    ...
    LIBMWVISIONRT_API void MWVIP_OpticalFlow_LK_GDER_C(void **inPortAddr,
        creal32_T  *outVel, 
        real32_T  *gradCC,
        real32_T  *gradRC,
        real32_T  *gradRR,
    ...
    LIBMWVISIONRT_API void MWVIP_OFLK_ConvT_D(const real_T **inPortAddr, 
        real_T *out, 
        const real_T *kernel, 
        int_T inWidth, 
        int_T kernelLen);

    LIBMWVISIONRT_API void MWVIP_OFLK_ConvT_R(const real32_T **inPortAddr, 
        real32_T *out, 
        const real32_T *kernel, 
        int_T inWidth, 
        int_T kernelLen);
