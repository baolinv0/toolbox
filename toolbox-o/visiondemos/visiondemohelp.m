function htmlfilename = visiondemohelp
% VISIONDEMOHELP Computer Vision System Toolbox demo help function.
%   VISIONDEMOHELP Returns the path to the HTML help information file
...
htmlfilename = [matlabroot '/toolbox/vision/visiondemos/html/' htmlfilename '.html'];
